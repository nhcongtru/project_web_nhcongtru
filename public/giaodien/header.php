...
<header id="header">
	<div class="row">
		...
		<div class="Account col-md-4 col-sm-5">
			<button class="login btn btn-outline-success"><a style="text-decoration: none; color: green;font-weight:bold;" href='<?php
					...
					?> </a></button>
			<button class="btn btn-outline-danger register"><a class="register" style="text-decoration: none; color: red;font-weight:bold;" href='<?php
																																					if (isset($_SESSION['login'])) {
